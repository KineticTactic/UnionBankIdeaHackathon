...
| 4 | COMPASS           | compass      | 8004 | `layer4 compass orchestration/services/orchestration/main.py` | Next-best-action agent (LangGraph 7 nodes). Consumes signal-detections, emits action plans. | NVIDIA LLM (Azure Foundry / NVIDIA) for cognition + NBA | kafka |
