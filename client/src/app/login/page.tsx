    ...
    <div className="w-full min-h-screen flex" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
        ...
        <div className="relative z-10 p-12 flex flex-col h-full">
          ...
          <div className="flex items-center gap-3 mb-auto">
            <div className="w-10 h-10 rounded-xl flex items-center justify-center"
              ...
              <span className="text-white text-[12px] font-black tracking-tight">UB</span>
            </div>
            <div>
              <p className="text-white text-[15px] font-bold tracking-tight leading-none">PCOP</p>
              <p className="text-white/40 text-[10px] tracking-widest uppercase mt-0.5">Union Bank</p>
            </div>
          </div>
          ...
          <div className="my-auto">
            <div className="inline-flex items-center gap-2 mb-6 px-3 py-1.5 rounded-full"
              ...
              <span className="text-sky-300 text-[10px] font-semibold uppercase tracking-widest">AI Innovation Hackathon 2026</span>
            </div>
          ...
          <p className="text-white/20 text-[10px] mt-8 uppercase tracking-widest">
            Union Bank · AI Innovation · Hackathon 2026
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center bg-[#F7F8FC] px-6 py-12">
        ...
        <div className="flex lg:hidden items-center gap-2.5 mb-10">
          ...
          <span className="text-[#0f2d5c] text-[15px] font-bold">PCOP · Union Bank</span>
        </div>
