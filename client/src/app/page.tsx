        ...
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-white/10 border border-white/20 flex items-center justify-center">
              <span className="text-white text-[9px] font-black">UB</span>
            </div>
          ...
          <div className="flex items-start gap-5 mb-10">
            ...
            <div>
              ...
              <p className="text-[14px] text-amber-700 leading-relaxed max-w-3xl">
                This is a <strong>functional prototype</strong> built to show exactly how PCOP looks and behaves in a real Union Bank deployment.
        ...
        <div className="max-w-5xl mx-auto flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-2.5">
            <div className="w-6 h-6 rounded bg-[#0f2d5c] flex items-center justify-center">
              <span className="text-white text-[8px] font-black">UB</span>
            </div>
            <span className="text-[12px] text-slate-500">PCOP · Union Bank AI Innovation Hackathon 2026</span>
          </div>
