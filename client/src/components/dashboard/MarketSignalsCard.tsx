...
const SEV_CONFIG: Record<string, { icon: React.ReactNode; bg: string; text: string; border: string }> = {
    high:   { icon: <AlertTriangle className="w-3.5 h-3.5" />, bg: "bg-crimson-soft",    text: "text-crimson",    border: "border-red-100" },
    medium: { icon: <TrendingDown className="w-3.5 h-3.5" />, bg: "bg-copper-soft",  text: "text-copper-dark",  border: "border-amber-100" },
    info:   { icon: <Info className="w-3.5 h-3.5" />,         bg: "bg-teal-soft",   text: "text-teal-dark",   border: "border-blue-100" },
};
