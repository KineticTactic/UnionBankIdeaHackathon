                        ...
                        {chartData.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                    ...
                                    />
                                    <Area type="monotone" dataKey="credit" stackId="1" stroke="var(--sage-brand)" fill="var(--sage-brand)" fillOpacity={0.2} />
                                    <Area type="monotone" dataKey="debit" stackId="2" stroke="var(--crimson)" fill="var(--crimson)" fillOpacity={0.2} />
                                </AreaChart>
                            </ResponsiveContainer>
                        ) : (
                            ...
                            <TableBody>
                                {transactions.slice(0, 20).map((t, idx) => (
                                    <TableRow key={idx}>
                                        ...
                                        <TableCell className={`text-right text-sm font-medium ${t.direction === 'credit' ? 'text-sage-brand' : 'text-slate-900'}`}>
